<?php
class ModelExtensionModuleHotSearch extends Model {
  ...
  public function getProduct($product_id) {
	...
	public function getProductCategories($product_id) {
		...
		$ocstore = $this->config->get('module_hotsearch_ocstore');
		...
		if ($ocstore) {
			$query = $this->db->query(
				"	SELECT
					...
					ON
						pc.category_id = cd.category_id AND
						cd.language_id = '".(int)$this->config->get('config_language_id')."'
					WHERE
						pc.product_id = '".(int)$product_id."' AND pc.main_category = 1
				");
		} else {
			$query = $this->db->query(
				"	SELECT
