...
//heading
$_['heading_title']                             = '<span style="color:#449DD0; font-weight:bold">Модуль блога: Настройки</span>';
$_['heading_title_main']                        = 'Модуль блога: настройки';
$_['text_edit']                                 = 'Изменить настройки модуля блога';
$_['text_module']                               = 'Модули';
$_['text_undefined']                            = 'Не определено';
$_['text_width']                                = 'Ширина';
$_['text_height']                               = 'Высота';

$_['help_install_demo_data']                    = '<h4> Добро пожаловать в настройку модуля блога </h4><p> Вы только что установили модуль блога - наиболее многофункциональное расширение блога для Opencart. Чтобы помочь вам быстро начать работу, вы можете начать с установки демонстрационных данных. Если вы чувствуете себя комфортно без демонстрационных данных, вы можете пропустить эту опцию и сразу перейти к активации.</p><p> Если вам когда-нибудь понадобится вернуться к настройке, просто выключите блог и заново включите. </p>';
$_['warning_install_demo_data']                 = 'Вы собираетесь удалить все данные, которые есть в вашем блоге, и заменить их демонстрационными данными. Вы уверены, что хотите это сделать?';
//tab
...
$_['success_twig_compatible']                   = 'Success: Twig support enabled. Please go to Blog Module!';
